...
class World:									# I choose to define the world as a class. This makes it more straightforward to import into the game.
	map = [
		...
		[riddlerTile(barriers = [barriers.Wall('w')],npcs = [NPC.Riddler()]),							EmptySpace(),	 	 															EmptySpace(barriers = [barriers.Wall('e')]),    										SpaceTile(barriers = [barriers.pWall('w')]),   						SpaceTile(),   																													SpaceTile(),		SpaceTile(),		SpaceTile(),	SpaceTile(),	SpaceTile()],
